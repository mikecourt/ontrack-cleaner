      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 flex flex-col">
          <div
            ...
            onDrop={handleDrop}
            className={cn(
              "w-full border-2 border-dashed rounded-xl p-12 transition-all duration-300",
              isDragging
          ...
          {files.length > 0 && (
            <Button
              ...
              size="lg"
              className="mt-6 w-full bg-gradient-primary shadow-md hover:shadow-lg"
            >
